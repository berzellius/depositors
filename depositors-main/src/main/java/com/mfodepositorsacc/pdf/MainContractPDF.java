 ...
 */
public class MainContractPDF extends AbstractITextPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document doc,
        ...
        // Css
        ClassPathResource cssClassPathResource = new ClassPathResource("css/maincontract.css");
        ...
        for(String html : htmlBlocks) {
            InputStream cssIs = cssClassPathResource.getInputStream();
            ...
            worker.parseXHtml(writer, doc, is, cssIs, Charset.forName("UTF-8"));
        }
    ...
    public class HeaderHelper extends PdfPageEventHelper{
        ...
        public void onEndPage(PdfWriter writer, Document document){
            ...
            try {
                ...
                tableBottom.getDefaultCell().setFixedHeight(20);
                tableBottom.getDefaultCell().setBorder(Rectangle.TOP);
                tableBottom.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);

                tableBottom.addCell(new Paragraph("Займодавец: ____________", f1));
                tableBottom.addCell(new Paragraph("Заемщик: ____________", f1));
                Paragraph pNum = new Paragraph("Страница ", f1);
                Chunk chunk = new Chunk(""+ writer.getPageNumber());
                pNum.add(chunk);
                tableBottom.addCell(pNum);

                tableBottom.writeSelectedRows(0, -1, 50, 30, writer.getDirectContent());
